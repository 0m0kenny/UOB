...
average_per_patient_df$Patient_no <- c(1:1000)
...
#load the dataset required
load("~/UOB/coursework/assess_data_1224.Rdata") #data in different directory so set absolute path

#get summary of the Y
summary(Y)

#create a box plot of the log 2 values of the data
boxplot(log2(Y+ 1))
...
ggplot(adj_p_val_df, aes(x = gene_no, y = -log10(p_values))) +
